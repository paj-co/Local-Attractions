...
public class UserEmailInDatabaseValidator implements ConstraintValidator<UserEmailInDatabase, String> {
    ...
    @Override
    public void initialize(UserEmailInDatabase constraintAnnotation) {
